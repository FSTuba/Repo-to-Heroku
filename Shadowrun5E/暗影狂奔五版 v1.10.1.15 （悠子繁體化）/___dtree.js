...
function TreeNode(id, pid, name, url, title, target, icon, iconOpen, open) {
    this.id = id;
...
dTree.prototype.add = function (
    ...
    this.aNodes[this.aNodes.length] = new TreeNode(
        id,
        pid,
        name,
        url,
